...
export function DataTableSliderFilter<TData>({ column, title }: DataTableSliderFilterProps<TData>) {
  ...
  // Base UI's Slider widens this to `number | readonly number[]` — the same
  // handler serves single and range sliders. A range slider only ever emits the
  // two-element form, and the guard below is what proves that to the compiler.
